<script lang="ts">
	...
	import flaskSvg from '$lib/assets/flask.svg';
...
═══════════════════════════════════════════════════════════════ -->
<div
	style="background:{PALETTE.bg}; min-height:100vh; font-family:{typography.fontSans}; position:relative"
>
	...
	<div style="padding:40px 18px 22px">
		...
		<!-- Footer -->
		<div
			style="display:flex; align-items:center; justify-content:center; gap:6px; font-size:10px; color:#64748b"
		>
			<img src={flaskSvg} alt="Indest Labs flask" class="footer-flask" />
